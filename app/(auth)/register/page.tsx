    ...
    <div className="w-full">
      ...
      <div className="mb-8 border border-slate-100 p-1 rounded-xl flex items-center bg-slate-50 w-full text-sm shadow-inner">
        <button
          ...
          className={`flex-1 py-3 px-2 rounded-lg font-semibold transition-all duration-200 ${
            selectedRole === 'user'
              ? 'bg-[#d89a42] text-white shadow-md transform scale-[1.02]'
      ...
      <div className="mt-6 text-center">
        <p className="text-sm text-slate-600">
          ...
          <Link
            href="/login"
            className="text-[#0B2341] font-bold hover:underline"
          >
            Log In
          </Link>
        </p>
